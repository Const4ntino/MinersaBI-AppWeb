...
export default function Login() {
  ...
  // Función simulada para manejar el submit del formulario
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    setIsLoading(true);
    console.log('Intento de inicio de sesión con:', email, 'y contraseña.');
    // Simular una carga breve para mostrar el estado del botón
    setTimeout(() => {
        setIsLoading(false);
        // Aquí se llamaría a la lógica de autenticación (ej: Firebase)
    }, 1500);
  };
